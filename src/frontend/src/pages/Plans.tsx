...
import { useGetCurrentPlan, useCreateCheckoutSession } from '../hooks/useQueries';
...
export default function Plans() {
  ...
  const handleSubscribe = async (plan: Plan) => {
    ...
    try {
      ...
      const planName = plan === Plan.monthly ? 'Monthly Premium' : 'Yearly Premium';
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Choose the perfect plan for your racing experience. Upgrade to Premium for the ultimate F1 racing adventure.
        </p>
      </div>
            ...
            >
              ...
              <CardContent className="space-y-6">
                ...
                <Button
                  className="w-full"
                  size="lg"
                  variant={isCurrentPlan ? 'outline' : planKey === 'free' ? 'secondary' : 'default'}
                  disabled={isCurrentPlan || isProcessing || planKey === 'free'}
