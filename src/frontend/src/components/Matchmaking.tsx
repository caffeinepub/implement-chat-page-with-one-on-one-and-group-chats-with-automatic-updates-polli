...
import { Clock, Search, Target, Trophy, Users, Zap } from "lucide-react";
...
export default function Matchmaking() {
  ...
  if (matchmakingState === "racing") {
    return <F1RaceTrack onBack={() => setMatchmakingState("idle")} />;
  }
    ...
    <div className="space-y-6">
      <Card className="bg-gradient-to-br from-primary/10 to-primary/5">
        <CardHeader>
          ...
          <CardDescription>
            Race against players with similar skill levels on the F1 track
          </CardDescription>
        </CardHeader>
              ...
              <Card className="border-primary/50 bg-primary/5">
                <CardContent className="pt-6 space-y-4">
                  ...
                  <p className="text-center text-sm text-muted-foreground">
                    Looking for players with {skillRating - 100} -{" "}
                    {skillRating + 100} SR
                  </p>
                </CardContent>
              </Card>
                ...
                <CardContent className="pt-6 space-y-4">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground">
                      Opponents found with similar skill level
                    </p>
                    <p className="text-sm text-muted-foreground mt-2">
                      Ready to race on the F1 track ({matchedPlayers.length}{" "}
                      opponents)
                    </p>
                  </div>
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p>
                Race on a full 3D F1 circuit with starting grid, pit lane, and
                finish line
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p>
                Collision detection and skill-based matchmaking for fair
                competition
              </p>
            </div>
          </div>
